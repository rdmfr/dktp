        ...
        <div class="row">
            ...
            ?>
                <div class="mt-4 p-5 bg-primary text-white rounded">
                    ...
                    <li>Jika semua sudah terisi dengan baik dan benar,mohon tunggu proses verifikasi yang dilakukan oleh admin.</li>
                    <li>Jika selama waktu 7x24 Jam admin belum memverifikasi pembuatan KTP, bisa hubungi di <div id="href">...</div>
                    </li>
                </div>
            <?php endif; ?>
        </div>
